  ...
  return (
    <div className="grid grid-cols-2 gap-5">
      ...
      <div className="glass p-6 text-center">
        <p className="text-[10px] font-mono tracking-[0.2em] text-[var(--text-sub)] mb-2">
          TEMPERATURE
        </p>
        <p
        ...
        <div className="mt-3 flex items-center justify-center gap-2">
          ...
          <span className="text-[9px] font-mono text-orange-300/50 tracking-widest">CELSIUS</span>
      ...
      <div className="glass p-6 text-center">
        ...
        <div className="mt-3 flex items-center justify-center gap-2">
          ...
          <span className="text-[9px] font-mono text-cyan-300/50 tracking-widest">RELATIVE</span>
